...
public class Region
{
    ...
    private List<int> NStepTargetListCount;
    ...
    public Region(int r)
    {
        ...
        NStepTargetListCount = new List<int>();
    }
    ...
    public void removeTargetFromList(Point t)
    {
    ...
    public void updateNStepTargetList(int stepNum)
    {
        if (TargetList.Count > 0)
        {
            if (NStepTargetList.Count > 0)
            {
                var S = NStepTargetList.ElementAt(NStepTargetList.Count - 1);
                if (S.Count != TargetList.Count)
                {
                    NStepTargetList.Add(cloneList(TargetList));
                    NStepTargetListCount.Add(stepNum);
                }
            }
            else
            {
    ...
    public List<int> getNStepTargetListCount()
    {
        return NStepTargetListCount;
    }
    ...
    public List<Point> cloneList(List<Point> PTS)
    {
        List<Point> p = new List<Point>();
