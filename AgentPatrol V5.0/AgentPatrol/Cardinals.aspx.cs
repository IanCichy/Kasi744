...
public partial class Cardinals : System.Web.UI.Page
{
    ...
    {
        btnNewRun.CssClass = "button-Upload";
    }
    ...
    {
        lblAlgorithmSelected.CssClass = "visible";
        file.CssClass = "button-Browse";
        btnUploadMap.CssClass = "button-Upload";
    }
    ...
    {
        lblAlgorithmSelected.CssClass = "hidden";
    ...
    protected void enableAlgorithmSelect()
    {
        ...
        btnAlgorithmSelect.CssClass = "button-Algorithm";
    ...
    private void enableControls()
    {
        ...
        btnOneStep.CssClass = "button-Steps";
        btnNStep.CssClass = "button-Steps";
    }
    ...
    */
    ...
    protected void btnAlgorithmSelect_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>alert('Please Select an Algorithm!')</script>");
        }
    }
