    ...
    <form runat="server">
        ...
        <div class="container">
            ...
            <div class="right-half-bottom">
                <br />
                <br />
                <asp:FileUpload ID="file" runat="server" CssClass="buttonBrowse" />
                <br />
                <asp:Button runat="server" ID="uploadMap" OnClick="uploadMap_Click" Text="Upload Map" CssClass="button-Upload" />
